...
- Mixing a whole-record read with bin-scoped ops in one `operate` (use per-bin reads only; see [operate-record-lock-read-write.md](operate-record-lock-read-write.md))

**See also**

- [operate-record-lock-read-write.md](operate-record-lock-read-write.md) (record lock, mixed read/write, latency)
- [operate-mixed-read-write.md](../examples/operate-mixed-read-write.md)
