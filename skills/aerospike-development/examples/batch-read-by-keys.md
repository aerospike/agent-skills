...
Related rules: [batch-parallel-key-operations.md](../references/batch-parallel-key-operations.md)
...
**Official batch links + minimal snippet:** [batch-official-links.md](batch-official-links.md)
...
Use your SDK’s batch API with a **list of keys** built from known identifiers—**each key at most once** per batch; dedupe or coalesce on the client, and use batch **`operate`** when one key needs multiple operations (see [batch-parallel-key-operations.md](../references/batch-parallel-key-operations.md)). Pseudocode:
...
Take the real signature from [batch-official-links.md](batch-official-links.md) rather than this
sketch.
