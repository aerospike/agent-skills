...
- Mixing a whole-record read with bin-scoped ops in one `operate` (use per-bin reads only; see [binop-operate-record-lock-read-write.md](aerospike-development-binop-operate-record-lock-read-write.md))
